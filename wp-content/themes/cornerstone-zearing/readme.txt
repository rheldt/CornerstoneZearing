...
* Tweak: Delete deprecated `elementor_cornerstone_theme_load_textdomain` filter hook
* Tweak: Delete deprecated `elementor_cornerstone_theme_register_menus` filter hook
* Tweak: Delete deprecated `elementor_cornerstone_theme_add_theme_support` filter hook
* Tweak: Delete deprecated `elementor_cornerstone_theme_add_woocommerce_support` filter hook
* Tweak: Delete deprecated `elementor_cornerstone_theme_enqueue_style` filter hook
* Tweak: Delete deprecated `elementor_cornerstone_theme_register_elementor_locations` filter hook
...
* New: Added `elementor_cornerstone_theme_load_textdomain` filter for load theme's textdomain
* New: Added `elementor_cornerstone_theme_register_menus` filter for register the theme's default menu location
* New: Added `elementor_cornerstone_theme_add_theme_support` filter for register the various supported features
* New: Added `elementor_cornerstone_theme_add_woocommerce_support` filter for register woocommerce features, including product-gallery zoom, swipe & lightbox features
* New: Added `elementor_cornerstone_theme_enqueue_style` filter for enqueue style
* New: Added `elementor_cornerstone_theme_register_elementor_locations` filter for register elementor settings
