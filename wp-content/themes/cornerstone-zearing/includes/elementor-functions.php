...
add_action( 'elementor/experiments/default-features-registered', function( \Elementor\Core\Experiments\Manager $experiments_manager ) {
	$experiments_manager->add_feature( [
		...
		'title' => esc_html__( 'Hello Theme Header & Footer', 'cornerstone-elementor' ),
		'description' => sprintf( __( 'Use this experiment to design header and footer using Elementor Site Settings. <a href="%s" target="_blank">Learn More</a>', 'cornerstone-elementor' ), 'https://go.elementor.com/wp-dash-header-footer' ),
