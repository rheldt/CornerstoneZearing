...
class Settings_Header extends Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Header', 'cornerstone-elementor' );
	}
	...
	protected function register_tab_controls() {
		$this->start_controls_section(
			...
			[
				...
				'label' => esc_html__( 'Header', 'cornerstone-elementor' ),
			]
		);
		...
		if ( 1 === count( $menus ) ) {
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Menu Layout', 'cornerstone-elementor' ),
					'type' => Controls_Manager::SELECT,
					'default' => 'horizontal',
					'options' => [
						'horizontal' => esc_html__( 'Horizontal', 'cornerstone-elementor' ),
						'dropdown' => esc_html__( 'Dropdown', 'cornerstone-elementor' ),
					],
					'frontend_available' => true,
				]
			);
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Breakpoint', 'cornerstone-elementor' ),
					'type' => Controls_Manager::SELECT,
					'default' => 'tablet',
					'options' => [
						/* translators: %d: Breakpoint number. */
						'mobile' => sprintf( esc_html__( 'Mobile (< %dpx)', 'cornerstone-elementor' ), $breakpoints['md'] ),
						/* translators: %d: Breakpoint number. */
						'tablet' => sprintf( esc_html__( 'Tablet (< %dpx)', 'cornerstone-elementor' ), $breakpoints['lg'] ),
						'none' => esc_html__( 'None', 'cornerstone-elementor' ),
					],
					'selector' => '.site-header',
					'condition' => [
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Toggle Color', 'cornerstone-elementor' ),
					'type' => Controls_Manager::COLOR,
					'condition' => [
						'hello_header_menu_display' => 'yes',
					],
	...
	public function get_additional_tab_content() {
		if ( ! defined( 'ELEMENTOR_PRO_VERSION' ) ) {
			return sprintf( '
				...
				',
				esc_html__( 'Create a custom header with multiple options', 'cornerstone-elementor' ),
			...
			return sprintf( '
				...
				',
				esc_html__( 'Create a custom header with the new Theme Builder', 'cornerstone-elementor' ),
				esc_html__( 'With the new Theme Builder you can jump directly into each part of your site', 'cornerstone-elementor' ),
				esc_html__( 'Create Header', 'cornerstone-elementor' ),
				get_template_directory_uri() . '/assets/images/go-pro.svg',
