...
function hello_elementor_settings_page() {
	...
	$menu_hook = add_theme_page(
		esc_html__( 'Hello Theme Settings', 'cornerstone-elementor' ),
		esc_html__( 'Theme Settings', 'cornerstone-elementor' ),
		'manage_options',
...
function hello_elementor_settings_page_scripts() {
	...
	wp_set_script_translations( $handle, 'cornerstone-elementor' );
...
function hello_elementor_settings_page_render() {
	?>
	<div id="cornerstone-elementor-settings"></div>
	<?php
}
...
function hello_elementor_render_tweaks( $settings_group, $settings ) {
	...
	hello_elementor_do_tweak( $settings_group . $settings['cornerstone_theme'], function() {
