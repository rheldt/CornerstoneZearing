...
const SETTINGS = {
  ...
  cornerstone_theme: '_cornerstone_theme'
};
const SettingsPage = () => {
  ...
  const saveSettings = () => {
    ...
    settings.save();
    (0, _data.dispatch)('core/notices').createNotice('success', (0, _i18n.__)('Settings Saved', 'cornerstone-elementor'), {
      type: 'snackbar',
      isDismissible: true
    });
  };
  ...
  }, /*#__PURE__*/React.createElement("h1", null, (0, _i18n.__)('Hello Theme Settings', 'cornerstone-elementor'))))), /*#__PURE__*/React.createElement("div", {
  ...
  }, (0, _i18n.__)('Save Settings', 'cornerstone-elementor')))), /*#__PURE__*/React.createElement("div", {
...
const SettingsPanel = ({
  ...
  return /*#__PURE__*/React.createElement(_components.PanelBody, {
    title: (0, _i18n.__)('Hello Theme Settings', 'cornerstone-elementor')
  }, /*#__PURE__*/React.createElement(_components.Notice, {
    status: "warning",
    isDismissible: "false"
  }, /*#__PURE__*/React.createElement(_components.Dashicon, {
    icon: "flag"
  }), (0, _i18n.__)('Be cautious, disabling some of the following options may break your website.', 'cornerstone-elementor')), /*#__PURE__*/React.createElement(_components.ToggleControl, {
    label: (0, _i18n.__)('Disable description meta tag', 'cornerstone-elementor'),
    help: (0, _i18n.__)('Remove the description meta tag in singular content pages that contain an excerpt.', 'cornerstone-elementor'),
    ...
    label: (0, _i18n.__)('Disable skip link', 'cornerstone-elementor'),
    help: (0, _i18n.__)('Remove the "Skip to content" link used by screen-readers and users navigating with a keyboard.', 'cornerstone-elementor'),
    ...
    label: (0, _i18n.__)('Disable page title', 'cornerstone-elementor'),
    help: (0, _i18n.__)('Remove the section above the content that contains the main heading of the page.', 'cornerstone-elementor'),
    ...
    label: (0, _i18n.__)('Unregister Hello style.css', 'cornerstone-elementor'),
    help: (0, _i18n.__)("Disable Hello theme's style.css file which contains CSS reset rules for unified cross-browser view.", 'cornerstone-elementor'),
    checked: !!settingsData[SETTINGS.HELLO_STYLE] || false,
    onChange: value => updateSettings(SETTINGS.HELLO_STYLE, value)
  }), /*#__PURE__*/React.createElement("code", {
    className: "code-example"
  }, " <link rel=\"stylesheet\" href=\"", prefix, "/wp-content/themes/cornerstone-elementor/style.min.css\" /> "), /*#__PURE__*/React.createElement(_components.ToggleControl, {
    label: (0, _i18n.__)('Unregister Hello theme.css', 'cornerstone-elementor'),
    help: (0, _i18n.__)("Disable Hello theme's theme.css file which contains CSS rules that style WordPress elements.", 'cornerstone-elementor'),
    checked: !!settingsData[SETTINGS.cornerstone_theme] || false,
    onChange: value => updateSettings(SETTINGS.cornerstone_theme, value)
  }), /*#__PURE__*/React.createElement("code", {
    className: "code-example"
  }, " <link rel=\"stylesheet\" href=\"", prefix, "/wp-content/themes/cornerstone-elementor/theme.min.css\" /> "));
};
...
document.addEventListener('DOMContentLoaded', () => {
  const rootElement = document.getElementById('cornerstone-elementor-settings');
  if (rootElement) {
