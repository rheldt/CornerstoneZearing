...
<cf_layout pagetitle="#pagetitle#" breadcrumbs="#breadcrumbs#"> 
	...
	<p>
		We understand that there are differing views on the purpose and means of this practice that are held
		by equally faithful and committed fellow disciples of Jesus Christ. Thus, it is with all due respect
		toward our brothers and sisters in Christ who do not view this issue the way that we do, that our
		desire here is to share what we as Cornerstone Church of Christ believes on the issue of baptism. 
	</p>
	...
	<ul class="unordered">
		...
		<li>
			...
			baptize infants. We can find no Scriptural examples of and, consequently, no biblical support 
			for this particular practice.<br />&nbsp;
		</li>
		<li>
	...
	<ul class="unordered">
		...
		<li>
			<em>Baptism</em> involves a total submersion under water. The Greek baptizo literally means "to dip
			or immerse" and, as the Bible tells us, we are being baptized into Jesus' death. (Romans 6:3-6)
			<br />&nbsp;
		</li>
		<li>
			We are buried with Him through baptism into death in order that, just as Jesus was raised from 
			the dead through the glory of the Father, we too may live a new life. (Acts 8:34-39) 
		</li>
	</ul>
